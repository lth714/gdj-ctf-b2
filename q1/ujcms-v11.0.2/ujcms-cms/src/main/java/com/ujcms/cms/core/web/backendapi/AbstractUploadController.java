...
import com.ujcms.common.image.Images;
import com.ujcms.common.image.ResizeMode;
...
import com.ujcms.common.web.exception.LogicException;
...
import static com.ujcms.common.web.Uploads.*;
...
public abstract class AbstractUploadController {
    ...
    protected Map<String, Object> doUpload(HttpServletRequest request, long limitByte, String types, String type,
        ...
        return doUpload(request, limitByte, types, type, extraHandle, null);
    }

    protected Map<String, Object> doUpload(HttpServletRequest request, long limitByte, String types, String type,
                                           @Nullable ExtraHandle extraHandle, @Nullable Long customUserId) throws IOException, EncoderException {
        ...
        try {
            ...
            if (AVATAR_TYPE.equalsIgnoreCase(type)) {
                pathname = SLASH + AVATAR_TYPE + SLASH + userId + SLASH +
