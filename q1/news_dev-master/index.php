...
<head>
  ...
  <title>融媒体新闻采编发布系统</title>
  <link rel="stylesheet" href="/baixiu/static/assets/css/style.css">
...
<body>
  <div class="wrapper">
    ...
    <div class="header">
      <h1 class="logo"><a href="index.php"><img src="/baixiu/static/assets/img/logo.png" alt=""></a></h1>
      <ul class="nav">
        <li><a href="detail.php"><i class="fa fa-glass"></i>奇趣事</a></li>
        <li><a href="javascript:;"><i class="fa fa-phone"></i>潮科技</a></li>
        <li><a href="list.php"><i class="fa fa-fire"></i>会生活</a></li>
        ...
        <ul class="body random">
          <li>
            <a href="javascript:;">
              ...
              <div class="pic">
                <img src="/baixiu/static/uploads/widget_1.jpg" alt="">
              </div>
            </a>
          </li>
          <li>
            <a href="javascript:;">
              ...
              <p class="reading">阅读(819)</p>
              <div class="pic">
                <img src="/baixiu/static/uploads/widget_2.jpg" alt="">
              </div>
            </a>
          </li>
          <li>
            <a href="javascript:;">
              ...
              <p class="reading">阅读(819)</p>
              <div class="pic">
                <img src="/baixiu/static/uploads/widget_3.jpg" alt="">
              </div>
            </a>
          </li>
          <li>
            <a href="javascript:;">
              ...
              <p class="reading">阅读(819)</p>
              <div class="pic">
                <img src="/baixiu/static/uploads/widget_4.jpg" alt="">
              </div>
            </a>
          </li>
          <li>
            <a href="javascript:;">
              ...
              <p class="reading">阅读(819)</p>
              <div class="pic">
                <img src="/baixiu/static/uploads/widget_5.jpg" alt="">
              </div>
            </a>
          </li>
        </ul>
      ...
      <div class="widgets">
        ...
        <ul class="body discuz">
          <li>
            <a href="javascript:;">
              <div class="avatar">
                <img src="/baixiu/static/uploads/avatar_1.jpg" alt="">
              </div>
              <div class="txt">
                <p>
          ...
          <li>
            <a href="javascript:;">
              <div class="avatar">
                <img src="/baixiu/static/uploads/avatar_2.jpg" alt="">
              </div>
              <div class="txt">
                <p>
                  <span>鲜活</span>9个月前(08-14)说:
    ...
    <div class="content">
      <div class="swipe">
        <ul class="swipe-wrapper">
          <li>
            <a href="#">
              <img src="/baixiu/static/uploads/slide_1.jpg">
              <span>融媒体要闻</span>
            </a>
          </li>
          <li>
            <a href="#">
              <img src="/baixiu/static/uploads/slide_2.jpg">
              <span>融媒体要闻</span>
            </a>
          </li>
          <li>
      ...
      <div class="panel focus">
        ...
        <ul>
          <li class="large">
            <a href="javascript:;">
              <img src="/baixiu/static/uploads/hots_1.jpg" alt="">
              <span>融媒体要闻</span>
            </a>
          </li>
          <li>
            <a href="javascript:;">
              <img src="/baixiu/static/uploads/hots_2.jpg" alt="">
              <span>星球大战：原力觉醒视频演示 电影票68</span>
            </a>
          </li>
          <li>
            <a href="javascript:;">
              <img src="/baixiu/static/uploads/hots_3.jpg" alt="">
              <span>你敢骑吗？全球第一辆全功能3D打印摩托车亮相</span>
            </a>
          </li>
          <li>
            <a href="javascript:;">
              <img src="/baixiu/static/uploads/hots_4.jpg" alt="">
              <span>又现酒窝夹笔盖新技能 城里人是不让人活了！</span>
            </a>
          </li>
          <li>
            <a href="javascript:;">
              <img src="/baixiu/static/uploads/hots_5.jpg" alt="">
              <span>又现酒窝夹笔盖新技能 城里人是不让人活了！</span>
            </a>
          </li>
        </ul>
      ...
      <div class="panel new">
        ...
        <div class="entry">
          ...
          <div class="main">
            <p class="info">admin 发表于 2019-05-29</p>
    ...
    <div class="footer">
      <p>© 2024 区域融媒体中心 | 融媒体新闻采编发布系统 | 技术支撑部运维</p>
    </div>
  </div>
  <script src="/baixiu/static/assets/vendors/jquery/jquery.js"></script>
  <script src="/baixiu/static/assets/vendors/swipe/swipe.js"></script>
  <script>
    //
