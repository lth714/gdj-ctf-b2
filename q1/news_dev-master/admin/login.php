...
<body>
	...
	<div class="login ">
		<form class="login-wrap <?php echo isset($message)?'jello animated':'' ?>" action="<?php echo $_SERVER['PHP_SELF']; ?>" method='post'>
			...
			<h3 style="text-align:center;margin-bottom:20px;">融媒体新闻采编发布系统</h3>
			...
			<div class="form-group">
				...
				<input id="email" name="email" type="text" class="form-control" placeholder="用户名" autofocus>
			</div>
			<div class="form-group">
